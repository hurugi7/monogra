<x-guest-layout>
  ...
  <div class="mt-16 mx-60 border-solid border-gray-300 rounded-lg border shadow-sm">
    ...
    <form action="{{ route('have_category.store') }}" method="post" class="mx-8 my-3">
      ...
      <input type="text" class="block w-full p-4 mb-5 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500" name="category_name" id="category_name">
